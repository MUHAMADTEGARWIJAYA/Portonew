...
const App = () => {
  ...
  return (
    <div className="min-h-screen bg-gray-900  justify-center items-center px-20 py-8">
      ...
      <div className="container flex mx-auto px-4">
        ...
        <div className="flex bg-amber-300 gap-12 xl:flex-row flex-col px-10">
          {cards.map((card) => (
            <GifCard
              key={card.id}
              title={card.title}
  ...
  <div className="flex w-full justify-center items-center py-10">
    <button
      className="relative inline-block p-px font-semibold leading-6 text-white bg-gray-800 shadow-2xl cursor-pointer rounded-xl shadow-white transition-transform duration-300 ease-in-out hover:scale-105 active:scale-95"
    >
      <span
