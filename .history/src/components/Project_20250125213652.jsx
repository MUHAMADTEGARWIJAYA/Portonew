...
const App = () => {
  const cards = [
    ...
    },
    {
      ...
      description: "Website organisasi menampilkan landingpage organisasi dan juga include dengan admin dasboard",
  ...
  return (
    <div className="min-h-screen bg-gray-900 flex justify-center items-center px-20 py-8">
      <div className="container mx-auto px-4">
        <h1 className="text-4xl font-bold text-center text-white mb-8">Projects</h1>
      
        <div className="flex gap-12 xl:flex-row flex-col px-10">
          {cards.map((card) => (
            <GifCard
              key={card.id}
              title={card.title}
