...
const Header = () => {
  ...
  return (
    ...
    <motion.div 
      className="xl:min-h-96 min-h-[600px]  bg-gray-900 flex flex-col justify-center items-center xl:gap-16"
    >
      ...
      <motion.div
        ...
        className="border-t border-gray-300 hidden xl:w-3xl" // Responsive width untuk xl
        />
    </motion.div>
  );
};
