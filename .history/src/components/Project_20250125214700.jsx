...
const App = () => {
  ...
  <div className="flex w-full justify-center items-center py-10">
    <button
      className="relative inline-block p-px font-semibold leading-6 text-white bg-gray-800 shadow-xl cursor-pointer rounded-xl shadow-white transition-transform duration-300 ease-in-out hover:scale-105 active:scale-95"
    >
      <span
