...
const Header = () => {
  ...
  return (
    ...
    <motion.div 
      className="xl:min-h-96 min-h-[400px]  bg-gray-900 flex flex-col justify-center items-center xl:gap-16"
    >
  ...
  className="border-t border-gray-300 h-10 bg-black flex items-start   xl:w-3xl" // Responsive width untuk xl
/>
    </motion.div>
  );
};
